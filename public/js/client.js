var Client = (function(window) {
  ...
  var showGameOverMessage = function(type) {
    ...
    switch (type) {
      case 'checkmate-win'  : header.addClass('alert-success').text('jaque mate ateo'); break;
      case 'checkmate-lose' : header.addClass('alert-danger').text('jaque mate ateo'); break;
      case 'forfeit-win'    : header.addClass('alert-success').text('El enemigo se rindio, no le dieron las tajadas'); break;
      case 'forfeit-lose'   : header.addClass('alert-danger').text('Muy debil, como se rinde prr?'); break;
      case 'stalemate'      : header.addClass('alert-warning').text('Ahogo al rey prrito'); break;
    }
